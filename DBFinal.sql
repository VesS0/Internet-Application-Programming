...
INSERT INTO `airline` VALUES (1,'AirlineVesic','Mira Popare 52','Serbia','Belgrade','vvesic@yahoo.com'),(2,'AirlineVladimir','Mira Popare 24','Serbia','Novi Sad','vvvesic@yahoo.com'),(3,'AirlineVesa','MemeVeme','Zerrg','Naqq','KOOOOOOOOO'),(4,'KO ZIVI','U ANANASU','NA DNU','MORA?','SUNDJER');
...
CREATE TABLE `airplane` (
  ...
  CONSTRAINT `airplaneAirline` FOREIGN KEY (`airplane_AirlineId`) REFERENCES `airline` (`airline_Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `manufAirplane` FOREIGN KEY (`airplane_ManufacturerId`) REFERENCES `manufacturer` (`manufacturer_Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `planeManuf` FOREIGN KEY (`airplane_AirplaneTypeId`) REFERENCES `airplanetype` (`airplaneType_Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `airplane` VALUES (1,'MirkoBrzi',1,1,1),(2,'MirkoSpori',2,1,1),(3,'MirkoMirko',3,2,1),(4,'HOOCCCKXH',1,2,3),(5,'JEROJ',2,3,1),(6,'CHOKOLADA',3,2,2),(7,'SOKO',2,3,1);
...
INSERT INTO `airport` VALUES ('DRG','Keks','Valjevo','Srbija',32,22),('PRV','Srbija','Beogra','Srbija',23,32),('TRC','Beogradi','Valjevo','Bec',22,12);
...
CREATE TABLE `flight` (
  ...
  CONSTRAINT `D2211D` FOREIGN KEY (`flight_StewardessId_4`) REFERENCES `user` (`user_UserName`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `DSSSSSS` FOREIGN KEY (`flight_StewardessId_5`) REFERENCES `user` (`user_UserName`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FlightAirportt` FOREIGN KEY (`flight_ExpectedAirportIdTo`) REFERENCES `airport` (`airport_Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `GDDDD` FOREIGN KEY (`flight_StewardessId_2`) REFERENCES `user` (`user_UserName`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `HGHG` FOREIGN KEY (`flight_StewardessId_1`) REFERENCES `user` (`user_UserName`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `bbb` FOREIGN KEY (`flight_CopilotId`) REFERENCES `user` (`user_UserName`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `ccc` FOREIGN KEY (`flight_GateIdTo`) REFERENCES `gate` (`gate_Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fghjhg` FOREIGN KEY (`flight_GateIdFrom`) REFERENCES `gate` (`gate_Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `flightAirport` FOREIGN KEY (`flight_AirportIdTo`) REFERENCES `airport` (`airport_Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `flightairporteowko` FOREIGN KEY (`flight_AirportIdFrom`) REFERENCES `airport` (`airport_Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `nng` FOREIGN KEY (`flight_PilotId`) REFERENCES `user` (`user_UserName`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `stew3` FOREIGN KEY (`flight_StewardessId_3`) REFERENCES `user` (`user_UserName`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `terminal` FOREIGN KEY (`flight_TerminalIdTo`) REFERENCES `terminal` (`terminal_Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `terminalId` FOREIGN KEY (`flight_TerminalIdFrom`) REFERENCES `terminal` (`terminal_Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `vvv` FOREIGN KEY (`flight_AirplaneId`) REFERENCES `airplane` (`airplane_Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `flightstate` (
  ...
  CONSTRAINT `ghghhjhjhjhj` FOREIGN KEY (`flightState_RadarId`) REFERENCES `radarcenter` (`radarCenter_Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `zzzaazaaa` FOREIGN KEY (`flightState_FlightId`) REFERENCES `flight` (`flight_Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `gate` (
  ...
  CONSTRAINT `gateAirport` FOREIGN KEY (`gate_AirportId`) REFERENCES `airport` (`airport_Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `xaxaxa` FOREIGN KEY (`gate_TerminalId`) REFERENCES `terminal` (`terminal_Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `gate` VALUES ('PRV',1,'GaNam',1),('PRV',2,'Dss',2),('DRG',3,'wew',3),('TRC',4,'ew',4),('PRV',2,'Rdd',5);
...
CREATE TABLE `radarcenter` (
  ...
  CONSTRAINT `saaaaqqqq` FOREIGN KEY (`radarCenter_FlightId`) REFERENCES `flight` (`flight_Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `rent` (
  ...
  CONSTRAINT `RentAirline` FOREIGN KEY (`Rent_AirlineId`) REFERENCES `airline` (`airline_Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `bnmjhhh` FOREIGN KEY (`Rent_AirplaneId`) REFERENCES `airplane` (`airplane_Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `terminal` VALUES (1,'Hhh','PRV'),(2,'ee','DRG'),(3,'eww','TRC'),(4,'eww','PRV'),(5,'ggg','PRV'),(6,'Beograd','Trc');
...
CREATE TABLE `user` (
  ...
  CONSTRAINT `UserAirline` FOREIGN KEY (`user_AirlineId`) REFERENCES `airline` (`airline_Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES ('dd','aa','dd','aa','0','2017-06-15','dd',1,'Employee',1),('ffaa','ffaa','ffaa','ffaa','M',NULL,'ffaa',3,'Pilot',0),('vesa','vesa','vesa','vesa','M',NULL,'vesa',1,'Employee',0),('vesaa','vesaa','vesaa','vesaa','M',NULL,'vesaa',2,'Stewardess',0),('vlaa','vlaaadd','vlaa','daa','M',NULL,'vlaa',1,'Stewardess',0);
...
-- Dump completed on 2017-09-13 16:27:19
